...
export class ConfirmModal implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ConfirmModal>, 
    @Inject(MAT_DIALOG_DATA) public boardUserComponent: BoardUserComponent,  private fb: FormBuilder,private deviceService: DeviceService, private objectService: ObjectService) {
